...
if __name__ == "__main__":
    ...
    path_mesa = r'.\sample_data_healthy_training\mesa\polysomnography\edfs\mesa-sleep-0558.edf'
    ann_path_mesa = r'.\sample_data_healthy_training\mesa\polysomnography\annotations-events-nsrr\mesa-sleep-0558-nsrr.xml'

    path_shhs1 = r'C:\Users\Shaggy\OneDrive - Aalborg Universitet\Dokumenter\PhD\data_loader\sample_dataset\shhs\polysomnography\edfs\shhs1\shhs1-200001.edf'
    ann_path_shhs1 = r'C:\Users\Shaggy\OneDrive - Aalborg Universitet\Dokumenter\PhD\data_loader\sample_dataset\shhs\polysomnography\annotations-events-nsrr\shhs1\shhs1-200001-nsrr.xml'

    path_shhs2 = r'C:\Users\Shaggy\OneDrive - Aalborg Universitet\Dokumenter\PhD\data_loader\sample_dataset\shhs\polysomnography\edfs\shhs2\shhs2-200077.edf'
    ann_path_shhs2 = r'C:\Users\Shaggy\OneDrive - Aalborg Universitet\Dokumenter\PhD\data_loader\sample_dataset\shhs\polysomnography\annotations-events-nsrr\shhs2\shhs2-200077-nsrr.xml'

    #data = mne.io.read_raw_edf(path_mesa)
    #df = data.to_data_frame()  
    #fear = df["Pleth"]
    #import matplotlib.pyplot as plt

    #fear_sub = fear.iloc[0:2000]
    #plt.figure()
    #plt.plot(fear_sub)
    #mesa_df = LoadSleepData('mesa').loadSingleFile(path_mesa, ann_path_mesa)
    
    #meeesaaa= LoadSleepData('mesa').loadSingleFile(r".\sample_dataset\mesa\polysomnography\edfs\mesa-sleep-0001.edf",
    #                                               r'.\sample_dataset\mesa\polysomnography\annotations-events-nsrr\mesa-sleep-0001-nsrr.xml',augment_data=True)
    #meeesaaa2= LoadSleepData('mesa').loadSingleFile(r".\sample_dataset\mesa\polysomnography\edfs\mesa-sleep-0001.edf",
    #                                               r'.\sample_dataset\mesa\polysomnography\annotations-events-nsrr\mesa-sleep-0001-nsrr.xml',augment_data=False)
    #print(meeesaaa["labels"].value_counts())
    #print(meeesaaa2["labels"].value_counts())
    """
    ...
    """
    '''
    LoadSleepData('mesa',root_folder="",pre_root='H:').runAllFiles(save_as_chunks=False,
                                                                                 overwrite=False,
                                                                                 only_healthy_subjects=False,
                                                                                 root_output_folder='H:processed_mesa/',
                                                                                 augment_data=False)
    '''
    """
    ...
    LoadSleepData('shhs2',root_folder="shhs",pre_root='H:').runAllFiles(save_as_chunks=False,
                                                                                 ...
                                                                                 augment_data=False)
    """
    #LoadSleepData('mesa',root_folder="sleep_data/train_set").runAllFiles(overwrite=True,only_healthy_subjects=True,root_output_folder="new/processed_data_train")
    #LoadSleepData('mesa',root_folder="sleep_data/test_set").runAllFiles(overwrite=True,only_healthy_subjects=True,root_output_folder="new/processed_data_test")
    #LoadSleepData('mesa',root_folder="sample_data_healthy_training").runAllFiles(overwrite=True,only_healthy_subjects=True,root_output_folder="testfornan/processed_data_test")
    

    
    #a = LoadSleepData('mesa',root_folder="",pre_root='H:').GetListOfHealthyParticipants(5)
    
    
    all_subject = glob.glob(r'D:\mesa\polysomnography\edfs\*')
    all_subject = [x.split(os.sep)[-1].split('.')[0] for x in all_subject]
    all_processed_subjects = glob.glob(r'D:\processed_mesa\mesa\*')
    ...
    missing_file = LoadSleepData('mesa').loadSingleFile(r"D:\mesa\polysomnography\edfs\mesa-sleep-3013.edf",
                                                   r'D:\mesa\polysomnography\annotations-events-nsrr\mesa-sleep-3013-nsrr.xml',augment_data=False)    
    print(np.unique(missing_file['labels']))
    tx= missing_file['labels']
    from dataset_densenet import ECGDataSetSingle2

    test_1 = ECGDataSetSingle2(r'D:\processed_mesa\mesa\mesa-sleep-3013.pkl')
    test_1_label = test_1.labels.cpu().detach().numpy()
    print(np.unique(test_1_label))

    exit()
    missing_file2 = LoadSleepData('mesa').loadSingleFile(r"D:\mesa\polysomnography\edfs\mesa-sleep-2292.edf",
                                                   r'D:\mesa\polysomnography\annotations-events-nsrr\mesa-sleep-2292-nsrr.xml',augment_data=False)   
    
    
    LoadSleepData('mesa',root_folder="",pre_root='D:').runAllFiles(save_as_chunks=False,
                                                                                 overwrite=False,
                                                                                 only_healthy_subjects=False,
                                                                                 root_output_folder='D:processed_mesa/',
                                                                                 augment_data=False)
